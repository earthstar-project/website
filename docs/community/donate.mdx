...
meta:
  title: Donate
  description: Earthstar is a non-profit project aiming to create a freer, fairer internet. As such it relies on the freely given contributions of volunteers to survive. It's really great when those volunteers can dedicate themselves fully to the project, without having to use their spare time!
---

...
A Commons is like a shared folder holding Documents.  Typically it's shared with a small group of trusted people.

Each Commons has an address like `+bookclub.a18bu7axtn`. The first part helps you see which space you're interacting with, and the second, scrambly part makes it hard for others to guess.
...
A Pocket is a physical copy of the data in a Commons.

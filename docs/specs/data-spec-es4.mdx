---
meta:
  title: es.4 Data Format
  description: The es.4 data format specification.
---
...
This data format is superseded by [es5](/specs/data-spec-es5). Earthstar implementations SHOULD write `es.5` documents by default.

Users should not lose any of their existing data because of new formats. Implementations SHOULD have compatibility with superseded Earthstar formats.

## Warning: old vocabulary

This document uses old vocabulary.  It should be updated:
* **Workspaces** have been renamed to **Shares**.

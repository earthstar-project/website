...
<details>
 <summary>Instructions for installing a static file server</summary>
...
- Rather than hardcoding the share and author keypairs into the chat itself, can you refactor this app to use the `Earthstar.SharedSettings` API?

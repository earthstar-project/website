...
meta:
  ...
  description: Learn about configuring and running your own extensible Earthstar replica server.
---
...
The replica servers module offers a selection of pre-configured replica servers, as well as a
...
- [Glitch template](https://github.com/earthstar-project/replica-server-glitch)
- [Fly.io template](https://github.com/earthstar-project/replica-server-fly)

...
query it back out again

make another replica without the secret

try to write to it

sync the two replicas
  
Let's begin by creating an author keypair. We'll use this to write some data shortly.

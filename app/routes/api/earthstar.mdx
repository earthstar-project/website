...
(drawing of a Peer class inside your app, next to its business logic)
...
When you first query a document, there is no result. But StorageCache can be subscribed to for updates:

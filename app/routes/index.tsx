      ...
      <div className="flex flex-col md:flex-row items-baseline gap-6">
        <div className="flex flex-row gap-4 items-center md:flex-col">
          ...
          <p className="text-lg max-w-prose ">
            ...
            of data — messages, blog posts, photos, <em>anything</em> —
        ...
        <div className="flex flex-row gap-4 items-center  md:flex-col">
          ...
          <p className=" max-w-prose text-lg">
            Your data is here for the long haul. Everyone keeps a working <span className="text-es-blue text-bold">replica</span> of their share, so servers are just a nice-to-have.
          </p>
        ...
        <div className="flex flex-row gap-4 items-center md:flex-col">
          ...
          <p className=" max-w-prose text-lg">
            Interact with your <span className="text-es-green">documents</span> however you want: through home-cooked
